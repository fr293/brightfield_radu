...
# OPEN SERIAL TRIGGER
try:
    ser_trig = serial.Serial('COM7', 19200, timeout=1)
    # to be sure that serial communication is closed
    atexit.register(ser_trig.close)
    print "serial trigger open"
except serial.SerialException:
    print('Could not connect to Camera Trigger')
...
# address for Shutter
cam1_exp_time_dec = camcapture.readRegister("F0F0081C")
...
# address for shutter
cam2_exp_time_dec = camcapture_2.readRegister("F0F0081C")
...
class ThPowerSupply(QThread):
    ...
    def run(self):  # method which runs the thread
        ...
        time_old_refresh_scr = time.clock()
        ...
        while (not self.done_ps):  # loop for getting data from actuator
            if (time.clock() - time_old_refresh_scr) > d_time:
                self.emit(SIGNAL("refresh_scr()"))
                time_old_refresh_scr = time.clock()
            time.sleep(0.02)
...
class PySideCam(QtGui.QWidget):
    ...
    def initUI(self):
        ...
        self.lab_plots_static.setText("Z TRACKING PLOT")
        ...
        self.txt_plots_name_image1.setPlaceholderText('filename')
        ...
        self.ctrl_plots_exposure_time_1.setMaximum(70.0)
        ...
        self.ctrl_plots_exposure_time_2.setMaximum(70.0)
        ...
        self.txt_plots_name_fileout.setPlaceholderText('Calibration File Name')
        ...
        self.slider_plots_bead_size.setProperty("value", 2)
        ...
        self.lab_plots_tab_letter_refresh_screen = QtGui.QLabel()

        # ==============================================

        self.lab_plots_tab_letter_camera_live = QtGui.QLabel()
        ...
        vbox_plots_h_butt_tab_lett_seq_start_stop.addWidget(self.lab_plots_tab_letter_refresh_screen)
        vbox_plots_h_butt_tab_lett_seq_start_stop.addStretch(1)
        vbox_plots_h_butt_tab_lett_seq_start_stop.addWidget(self.lab_plots_tab_letter_camera_live)
        vbox_plots_h_butt_tab_lett_seq_start_stop.addStretch(1)
        ...
        self.lab_plots_z_cent_air_static.setText("z center air (mm)")
        ...
        self.lab_video_static.setText("VIDEO")
        ...
        self.ctrl_zoom.setProperty("value", 5.0)
        ...
        self.lab_actuat_static.setText("Z ACTUATOR")
        ...
        self.ctrl_abs.setProperty("value", 3.850)
        ...
        self.lab_random_static.setText("TIME LAPSE")
        ...
        # &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
        self.butt_random_time_laps_start = QtGui.QPushButton("Start lapse", self)
        ...
        self.butt_random_time_laps_stop = QtGui.QPushButton("Stop lapse", self)
        ...
        self.txt_random_time_lapse_folder.setPlaceholderText('creep_test_filename')

        # ==============================================

        self.lab_random_time_laps_static_frames_no = QtGui.QLabel()
        self.lab_random_time_laps_static_frames_no.setText("Number of frames")
        self.lab_random_time_laps_static_frames_time = QtGui.QLabel()
        self.lab_random_time_laps_static_frames_time.setText("Period (s)")
        ...
        self.ctrl_random_timelaps_frame_no.setProperty("value", 541)
        ...
        self.ctrl_random_timelaps_frame_time = QtGui.QDoubleSpinBox()
        self.ctrl_random_timelaps_frame_time.setMinimum(0.0)
        self.ctrl_random_timelaps_frame_time.setSingleStep(0.1)
        self.ctrl_random_timelaps_frame_time.setMaximum(1000)
        self.ctrl_random_timelaps_frame_time.setDecimals(1)
        self.ctrl_random_timelaps_frame_time.setProperty("value", 0.5)
        ...
        self.ctrl_random_timelaps_t_ON_static.setText("Time On")
        ...
        self.ctrl_random_timelaps_t_OFF_static.setText("Duration")
        ...
        self.ctrl_random_timelaps_t_OFF.setProperty("value", 120)
        ...
        self.lab_demag_static.setText("DEMAGNETISE")
        ...
        self.lab_power_static.setText("COIL DRIVERS")

        # &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
        self.butt_ard_start = QtGui.QPushButton("Start polling drivers", self)
        self.connect(self.butt_ard_start, SIGNAL("pressed()"), self.butt_ard_start_Changed)

        # ==============================================

        self.butt_ard_stop = QtGui.QPushButton("Stop polling drivers", self)
        ...
        self.butt_pow_LR = QtGui.QPushButton("  N  ", self)
        ...
        self.ctrl_pow_LR.setProperty("value", 1)
        ...
        self.butt_pow_RL = QtGui.QPushButton("  S  ", self)
        ...
        self.ctrl_pow_RL.setProperty("value", 1)
        ...
        self.butt_pow_DOWN = QtGui.QPushButton("  E  ", self)
        ...
        self.ctrl_pow_DOWN.setProperty("value", 1)
        ...
        self.butt_pow_UP = QtGui.QPushButton("  W  ", self)
        ...
        self.ctrl_pow_UP.setProperty("value", 1)
        ...
        self.ctrl_pow_zDOWN.setProperty("value", 1)
        ...
        self.ctrl_pow_zUP.setProperty("value", 1)
        ...
        self.lab_exp_static.setText("EXPERIMENT")
        ...
        self.connect(self.th_power_supp, SIGNAL("refresh_scr()"), self.screen_refresh_display, Qt.DirectConnection)
    ...
    def screen_refresh_display(self):
        rand_nr = random.uniform(0, 1)
        self.lab_plots_tab_letter_refresh_screen.setText(str(round(rand_nr, 2)))
        return

    def camera_capture_status(self, txt_status):
        self.lab_plots_tab_letter_camera_live.setText(txt_status)
        return
    ...
    def log_data_time_laps(self):
        # edited by fr293 28/03/19 to move the log file to the new folder
        # path_file = os.getcwd()
        path_file = 'D:\\time_lapse_data\\' + 'time_lapse_run_log.csv'
        f_name = open(path_file, 'a')
    ...
    def butt_random_time_laps_start_Changed(self):
        ...
        if self.name_folder_time_laps == '':
            ...
            # self.folder_path_time_laps_local = 'time_laps\\' + self.name_folder_time_laps + '\\'
            # changed by fr293 25/03/19 to output outside the project directory
            self.folder_path_time_laps = 'D:\\time_lapse_data\\' + self.name_folder_time_laps + '\\'
            self.folder_path_time_laps_local = 'D:\\time_lapse_data\\' + self.name_folder_time_laps + '\\'
        ...
        self.folder_path_time_laps_c1_local = self.folder_path_time_laps_local + 'cam1\\'
    ...
    def drawFrames(self, qp):
        ...
        # 2016_01_14_E2_ECAD_laps31self.camera_capture_status("YES")
        small = 16.0
        ...
        # cv2.rectangle(n_frame_rect,(x61,y61),(x62,y62),(255,127,127),4)
        # cv2.rectangle(n_frame_rect,(x71,y71),(x72,y72),(255,127,127),4)
        # cv2.rectangle(n_frame_rect,(x81,y81),(x82,y82),(255,127,127),4)
        # cv2.rectangle(n_frame_rect,(x91,y91),(x92,y92),(255,127,127),4)
        # cv2.rectangle(n_frame_rect,(x101,y101),(x102,y102),(255,127,127),4)
        # cv2.rectangle(n_frame_rect,(x111,y111),(x112,y112),(255,127,127),4)
        # cv2.rectangle(n_frame_rect,(x121,y121),(x122,y122),(255,127,127),4)
        # cv2.rectangle(n_frame_rect,(x131,y131),(x132,y132),(255,127,127),4)
        # cv2.rectangle(n_frame_rect,(x141,y141),(x142,y142),(255,127,127),4)
        ...
        if (self.time_laps_run_flag == True):
            ...
            if (self.index_time_laps < self.ctrl_random_timelaps_frame_no.value()):
                # if (time.clock() - self.time_old_time_laps > 0.4):
                # if (time.clock() - self.time_old_time_laps > self.ctrl_random_timelaps_frame_time.value()):
                # change this line to change the way the camera does its timings
                if (time.clock() - self.time_old_time_laps > self.ctrl_random_timelaps_frame_time.value()):
                    ...
                    # print grabtime
                    # edited 28/03/19 by fr293 to match time sheet name to folder name
                    with open(self.folder_path_time_laps_c1_local + self.name_folder_time_laps + '_time.csv',
                              'ab') as f:
                        writer = csv.writer(f)
                        writer.writerow([grabtime])
        ...
        if QtGui.QAbstractButton.isChecked(self.checkbox_XZ_section):
            ...
            delta_z_mm_lim_mmax = (self.z_c_oil - z_limit_mmax) * 1000
            delta_z_center_lim_mmax_xz = int(round(delta_z_mm_lim_mmax / self.scaling_fact, 0))
            ...
            cv2.line(n_frame_xz, (1, 130 + delta_z_center_lim_max_xz), (259, 130 + delta_z_center_lim_max_xz),
                     (0, 0, 0), 1)
            cv2.line(n_frame_xz, (1, 130 + delta_z_center_lim_mmax_xz), (259, 130 + delta_z_center_lim_mmax_xz),
                     (0, 0, 0), 1)
        ...
        # self.camera_capture_status("NOP")
