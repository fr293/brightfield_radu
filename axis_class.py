...
class Axis:
    def __init__(self,axis_name):
        ...
        self.absrel_tbutton = DoubleToggleButtonWidget(['Absolute','Relative'],self.absrel_toggle)
        ...
        self.feed_tbutton = DoubleToggleButtonWidget(['Start','Stop','Feed Axis'],self.feed)
    ...
    def feed(self):
        print(self.axis_name + ': feed' + self.feed_vel)
